...
urlpatterns = [
    ...
    path('publish-form/iotdashboard/tracking/publish-form/publish/',views.publish_control_command,name='publishapi'),
    ...
    path("iotdashboard/tracking/iotdashboard/publish-form/",views.livetracking,name="live_track_redirect"),
    path("publish-form/iotdashboard/live_tracking",views.livetracking,name="livetrack_2"),
